        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                for face_encoding in self.face_encodings:
                    ...
                    if name == 'Unknown':
                        intruderDB()
                        app_window = pyautogui.getWindowsWithTitle("Face Recognition")[0]

                        # Pencerenin ekran koordinatlarını alın
                        ...
                        subject = 'Python Security Camera Project'
                        body = """
                        Hello ! This is  Python Security Camera Project someone unknown has seen at your door. Please check
                        """
